  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await availabilityAction
        .addAvailability(userId, parsedStart.toISOString(), durationValue)
        .unwrap()
    ...
    <section className="availability-panel page-panel">
      <header className="availability-panel-header">
        <div>
          ...
          <p className="availability-card-desc">
            Pick a start time and how long you are free.
          </p>
        </div>
        <Button
          type="button"
      ...
      <form className="availability-form" onSubmit={handleSubmit}>
        <div className="ds-field">
          ...
          <div className="ds-help">
            Local time will be converted to UTC when submitted.
          </div>
        </div>
        <div className="ds-field">
        ...
        <div className="availability-form-actions">
          ...
          {statusMessage ? (
            <span className="availability-status availability-status--success">
              {statusMessage}
            </span>
          ) : null}
          {errorMessage ? (
            <span className="availability-status availability-status--error">
              {errorMessage}
            </span>
          ) : null}
        </div>
