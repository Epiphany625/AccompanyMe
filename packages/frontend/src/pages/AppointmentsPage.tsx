...
export const AppointmentsPage = () => {
        ...
        const fetchAppointments = async () => {
            ...
            try {
                ...
                if (axios.isAxiosError(error)) {
                    ...
                    setAppointmentsError(axiosError.response?.data?.message ?? axiosError.message)
                } else {
    ...
    const { upcomingAppointments, pastAppointments } = useMemo(() => {
        ...
        upcoming.sort((a, b) => getTimeValue(a.appointmentTime) - getTimeValue(b.appointmentTime))
        past.sort((a, b) => getTimeValue(b.appointmentTime) - getTimeValue(a.appointmentTime))
